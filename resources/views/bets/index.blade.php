            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex flex-row gap-3">
                    ...
                    @if(Auth::user()->isAdmin() || Auth::user()->isManager())
                        <a href="{{ route('bets.newCashout') }}" type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            {{ __('bets.add_cashout') }}
                ...
                <div>
                    <div class="my-4 relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                            @foreach ($bets as $bet)
                                <tr class="@if($bet->type == 'B') bg-green-100 @elseif($bet->type == 'C') bg-blue-100 @endif border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                   <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        @elseif($bet->type == 'C')
                                            {{$bet->cashout_ticket}}<br/>
                                            <small>{{$bet->cashout_reason}}</small>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4">
